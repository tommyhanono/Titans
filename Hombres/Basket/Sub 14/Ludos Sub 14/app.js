...
const STORAGE_KEY  = 'basket_ludos14_game_v1';
const HISTORY_KEY  = 'basket_ludos14_hist_v1';
...
═══════════════════════════════════════════════════════════════════════════ */
const TEMPLATES_URL = 'https://jsonblob.com/api/jsonBlob/019e763e-36f3-7936-bcef-2e29ac397b12';
let _tplCache = null;
...
async function saveCurrentAsTemplate() {
  ...
  toast('Guardando...');
  const templates = await _fetchTemplates();
  templates.push({ name: name.trim(), players: [...S.players] });
  await _pushTemplates(templates);
  _renderTplList(templates);
